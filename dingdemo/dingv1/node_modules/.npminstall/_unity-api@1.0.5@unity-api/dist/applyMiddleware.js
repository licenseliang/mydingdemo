...
function applyMiddleware(applyTo) {
    ...
    var method = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : '';
    ...
    return middlewares.reduceRight(function (prev, middleware, index) {
        ...
        var next = index === middlewares.length - 1 ? prev.bind(null, params) : prev.bind(null, options, params, resourceId, method);

        return index === 0 ? middleware(next)(options, params, resourceId, method) : middleware(next);
    }, applyTo);
}